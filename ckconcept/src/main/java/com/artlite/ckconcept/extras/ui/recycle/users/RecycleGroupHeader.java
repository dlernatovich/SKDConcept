...
public class RecycleGroupHeader extends BaseObject {

    private final int layoutID;
    public static final RecycleEvent K_MANAGE_EVENT = new RecycleEvent(0b1);

    public RecycleGroupHeader(int layoutID) {
     ...
     * View class
     */
    private final class View extends BaseRecyclerItem<RecycleGroupHeader> {
        ...
        @Override
        public void setUp(@NonNull RecycleGroupHeader extRecycleGroupHeader) {
