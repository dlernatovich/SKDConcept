...
public class DefaultChannelsPresenter extends AbstractChannelsPresenter {
     ...
     * @param view view
     */
    public DefaultChannelsPresenter(ChannelsContract.View view) {
        super(view);
    }
    ...
    @NonNull
    @Override
    public ChannelDetailsHelper.ChannelFilter getChannelFilter() {
        return ChannelDetailsHelper.ChannelFilter.APPROVAL;
    }
}
