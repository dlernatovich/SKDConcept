package com.artlite.ckconcept.extras.abs;
 ...
 */
public abstract class BaseExtrasView extends FrameLayout implements View.OnClickListener {
    ...
    public BaseExtrasView(Context context, AttributeSet attrs) {
        super(context, attrs);
        onInitializeView(context, attrs);
    }

    public BaseExtrasView(Context context, AttributeSet attrs, int defStyleAttr) {
