...
public class RecycleGroup extends BaseObject {
     ...
     */
    public RecycleGroup(int layoutID, @NonNull final MMXUserGroup group) {
     ...
     * View class
     */
    private final class RecycleItemView extends BaseRecyclerItem<RecycleGroup> {
        ...
        @Override
        public void setUp(@NonNull RecycleGroup recycleGroup) {
