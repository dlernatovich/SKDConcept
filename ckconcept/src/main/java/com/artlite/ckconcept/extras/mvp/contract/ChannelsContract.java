package com.artlite.ckconcept.extras.mvp.contract;
...
import com.artlite.ckconcept.extras.mvp.abs.BaseExtrasContract;
...
public interface ChannelsContract {
     ...
     * View class
     */
    interface View extends BaseExtrasContract.BaseView {
     ...
     * View class
     */
    abstract class ViewClass extends BaseExtrasContract.BaseViewClass implements View {
     ...
     * Presenter
     */
    interface Presenter extends BaseExtrasContract.BasePresenter {

        /**
         * Default cache time
         *
         * @see ChannelsContract.Presenter#getCacheOptions()
         */
         ...
         */
        @NonNull
        ChannelDetailsHelper.ChannelFilter getChannelFilter();
