...
public abstract class KitBaseGroupUserView extends KitBaseGroupUserView_View {

    public KitBaseGroupUserView(Context context) {
        super(context);
    }

    public KitBaseGroupUserView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public KitBaseGroupUserView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onCreateView() {
        ...
        //Create group header
        groupHeader = new KitRecycleGroupHeader(presenter.getGroupHeaderLayout());
        noGroupsCell = new KitRecycleNoGroups(presenter.getNoGroupsLayout());
        //Init data
     ...
     */
    @Override
    protected void onUserPressed(@NonNull KitRecycleUser recycleUser) {
     ...
     * @return presenter
     */
    protected abstract KitGroupContactContract.Presenter onCreatePresenter(@NonNull final KitGroupContactContract.ViewClass view);
