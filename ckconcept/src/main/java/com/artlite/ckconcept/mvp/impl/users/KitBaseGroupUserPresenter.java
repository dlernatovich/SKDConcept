...
public abstract class KitBaseGroupUserPresenter implements KitGroupContactContract.Presenter {

    protected final KitGroupContactContract.View view;

    /**
     * Constructor which provide the creating of the object from instance of the
     * {@link KitGroupContactContract.View}
     *
     * @param view instance of the View
     */
    public KitBaseGroupUserPresenter(@NonNull final KitGroupContactContract.View view) {
        this.view = view;
