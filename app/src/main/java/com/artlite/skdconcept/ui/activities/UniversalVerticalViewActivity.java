...
public final class UniversalVerticalViewActivity extends BSActivity {
    ...
    protected int getLayoutId() {
        return R.layout.activity_universal_vertical;
    }
        ...
        BSThreadManager.background(new BSThreadManager.OnThreadCallback() {
            ...
            public void onExecute() {
                for (int i = 0; i < 100; i++) {
                    ...
                    final KitBaseListObject listObject = new ListObjectVerticalLabel(object);
