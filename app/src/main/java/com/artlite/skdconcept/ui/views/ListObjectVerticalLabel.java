...
public final class ListObjectVerticalLabel extends KitBaseListObject<LabelObject> {
     ...
     */
    public ListObjectVerticalLabel(Parcelable object) {
        super(object);
    }
     ...
     */
    public ListObjectVerticalLabel(Parcel source) {
        super(source);
    }
     ...
     */
    private static class RecycleView extends BaseRecyclerItem<ListObjectVerticalLabel> {
         ...
         * {@link ListObjectVerticalLabel}
         *
         * @param object instance of the {@link ListObjectVerticalLabel}
         */
        @Override
        public void setUp(@NonNull ListObjectVerticalLabel object) {
        ...
        protected int getLayoutId() {
            return R.layout.recycle_label_object_vertical;
        }
