...
public final class KitListMessageTextMy extends KitBaseListObject<MMXMessage> {
     ...
     */
    private static class RecycleView extends BaseRecyclerItem<KitListMessageTextMy> {
         ...
         */
        @Override
        public void setUp(@NonNull KitListMessageTextMy object) {
