...
public final class KitListMessageLocationOther extends KitBaseListObject<MMXMessage> {
     ...
     */
    public KitListMessageLocationOther(Parcelable object) {
        super(object);
    }
     ...
     */
    public KitListMessageLocationOther(Parcel source) {
        super(source);
    }
     ...
     */
    private static class RecycleView extends BaseRecyclerItem<KitListMessageLocationOther> {
         ...
         *
         * @param object instance of the {@link KitListMessageLocationOther}
         */
        @Override
        public void setUp(@NonNull KitListMessageLocationOther object) {
        ...
        protected int getLayoutId() {
            return R.layout.recycle_ck_message_location_other;
        }
